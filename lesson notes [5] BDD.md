...
* [Тестирование с использованием BDD](https://habr.com/ru/post/139674/)
* [BDD in Actions](https://www.manning.com/books/bdd-in-action)
* [From manual to automation](https://www.youtube.com/watch?v=wpcQcroxt08)
* [BDD подход с точки зрения QA](https://www.youtube.com/watch?v=1MY2xTND5oY)

# Cucumber
* [Оффициальный сайт](https://cucumber.io/)
* [Документация](https://cucumber.io/docs/cucumber/)
* [Cucumber Expressions](https://cucumber.io/docs/cucumber/cucumber-expressions/)
* [Полезные практики создания автоматических тестов с использованием Cucumber-JVM](https://www.youtube.com/watch?v=tX3V90K8VIU)
